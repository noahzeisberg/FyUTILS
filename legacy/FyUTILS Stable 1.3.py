...
def menu():
    ...
    if update_available:
        time.sleep(0.03)
        print(Fore.LIGHTBLACK_EX + "║ " + color() + "[UPDATE] " + Fore.WHITE + "A new update is available!")
        time.sleep(0.03)
        print(Fore.LIGHTBLACK_EX + "║ " + color() + "[UPDATE] " + Fore.WHITE + "Current: " + version_type + "-" + version)
        time.sleep(0.03)
        print(Fore.LIGHTBLACK_EX + "║ " + color() + "[UPDATE] " + Fore.WHITE + "Target: " + "STABLE-" + target_version)
        time.sleep(0.03)
        print(Fore.LIGHTBLACK_EX + "╠" + "═" * 119)
    else:
        None
...
print(prefix("DEBUG") + "Support for multithreading will hopefully be back in STABLE-1.4.")
    ...
    try:
        ...
        if cmd == "exit" or cmd == "quit":
            ...
            try:
                ...
                ssh_port = int(input(Fore.LIGHTBLACK_EX + "║ " + Fore.WHITE + "Host port (default: 22)" + Fore.LIGHTBLACK_EX + " > " + Fore.WHITE))
                ssh_user = input(Fore.LIGHTBLACK_EX + "║ " + Fore.WHITE + "Login" + Fore.LIGHTBLACK_EX + " > " + Fore.WHITE)
                ssh_password = input(Fore.LIGHTBLACK_EX + "║ " + Fore.WHITE + "Password" + Fore.LIGHTBLACK_EX + " > " + Fore.WHITE)
                print(Fore.LIGHTBLACK_EX + "╚" + "═" * 119)
                print("")
                activity_start = time.time()
                add_command_detail("@" + ssh_server + ":" + str(ssh_port) + " as " + ssh_user)
